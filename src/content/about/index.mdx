...
Moreover, I enjoy learning from or alongside others through code review and pair programming. I'm incredibly grateful for the mentorship I've received thus far. It has motivated me to write code better than yesterday. Sometimes I learn outside of work, too, like how I played around with Gatsby, GraphQL and styled components to build this website. Check out the code on <a className="text-underline" href="https://github.com/nicolemamay/personal-website" target="_blank" aria-label="External Link">Github</a>.
